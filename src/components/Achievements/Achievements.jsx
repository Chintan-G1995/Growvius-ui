      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {achievements.map((item, i) => (
            <div
              key={i}
              className="text-center p-8 rounded-xl bg-[#F8FAFC] border border-gray-200 hover:border-[#2563EB] transition"
            >
              <div className="text-3xl font-extrabold text-[#2563EB] mb-2">
                {item.number}
              </div>
              <h4 className="font-semibold mb-1 text-[#0F172A]">{item.title}</h4>
